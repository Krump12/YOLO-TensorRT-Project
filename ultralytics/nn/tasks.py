...
'''
#2024.08.01 add by ZhangYalu
#Add block
#CRMSFF SAAM AtFPN Create in 2024.09 by zhangyalu
Name: zhangyalu
Time: 2024.09
Opt:  Create file CRMSFF SAAM AtFPN
'''
from ultralytics.nn.attentions.CRMSFF import *
from ultralytics.nn.attentions.SAAM import *
from ultralytics.nn.attentions.AtFPN import *
'''
AFPN Create in 2024.10.09 by zhangyalu
Name: zhangyalu
Time: 2024.09
Opt:  Create file AFPN
'''
from ultralytics.nn.attentions.AFPN import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            RepC3,
            PSA,
            #SAAM, AtFPN, CRMSFF_2, CRMSFF_3, add in 2024.09 by zhangyalu
            SAAM, AtFPN, ASCSM,
            #BasicConv, Upsample, Downsample_x2, Downsample_x4, ASFF_2, ASFF_3, add in 2024.10.09 by zhangyalu
            Upsample, Downsample_x2, Downsample_x4, BasicConv, Conv1_1,
            SCDown,
            C2fCIB
        }:
            # print(f"f: {f}, ch: {ch}")
            ...
            c2 = ch[f[-1]]
        #new add
        elif m in [CRMSFF_2, CRMSFF_3, ASFF_2, ASFF_3]:
            c2 = sum(ch[x] for x in f)
        else:
            c2 = ch[f]

        #print(f"Initializing module {m} with args: {args}")
